...
The kernel $$\phi$$ describes how an event's influence plays out overtime, and different choices of kernel will produce different models. In the context of this review, there are three worth stating. 
